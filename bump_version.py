...
"""
Version Bump Utility for CSV to JSON Converter
=============================================

This script increments the patch version of the CSV to JSON Converter project,
updates the version in csv_to_json.py, and appends a changelog entry to
changelog.txt. It uses only Python 3 standard library modules for compatibility.

Usage:
    python3 bump_version.py "Description of changes"

Example:
    python3 bump_version.py "Added support for custom JSON formatting"
"""
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Increment CSV to JSON Converter version and update changelog."
    )
    parser.add_argument(
        "description",
...
def increment_version(major, minor, patch):
    ...
    Returns:
        str: New version string (e.g., "1.0.1").
    """
...
def main():
    ...
    script_path = Path("csv_to_json.py")
